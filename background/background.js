...
const client = createClient('https://wzckrfrmhqevymvydfym.supabase.co', 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Ind6Y2tyZnJtaHFldnltdnlkZnltIiwicm9sZSI6ImFub24iLCJpYXQiOjE2OTk2MzIwMjYsImV4cCI6MjAxNTIwODAyNn0.75XRzoYmqd9OKdV7P75YFa0L8RKKj4NuDJ52kjXuFN0');
...
async function tryAutoVerify() {
    return new Promise((resolve, reject) => {
        chrome.storage.local.get(['verifyKey'], async result => {
            ...
            if(!('verifyKey' in result)) {
                reject('Verify key not in storage');
                return;
            }
